...
async function runDebug() {
    ...
    try {
        ...
        console.log('Abriendo diálogo de Nuevo Embudo...');
        const newBtn = await driver.findElement(By.xpath("//button[contains(., 'Nuevo Embudo')]"));
        await newBtn.click();

        console.log('Esperando el diálogo...');
        await driver.wait(until.elementLocated(By.xpath("//h2[contains(., 'Nuevo Embudo')]")), 5000);

        console.log('--- CAPTURANDO LOGS DE CONSOLA ---');
