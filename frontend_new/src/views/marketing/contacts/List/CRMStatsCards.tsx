...
const CRMStatsCards = ({ contactsData = [], totalContacts }: CRMStatsCardsProps) => {
  const theme = useTheme();

  // Read total from RTK Query cache if not provided
  const rtkTotal = useSelector((state: RootState) => state.contactsApi?.queries['getContacts({"page":0,"size":10})']?.data?.totalElements);
  const effectiveTotal = totalContacts ?? rtkTotal ?? contactsData.length;
          ...
          >
            ...
            >
              <CircularProgress
                ...
                thickness={4.5}
                sx={{
                  color: theme.palette?.action?.hover || '#f1f1f2',
                  position: 'absolute',
                }}
              />
              <CircularProgress
          ...
          >
            ...
            >
              ...
              <Box sx={{ mt: 2 }}>
                ...
                <Typography variant="caption" color="text.secondary">
                  {stats.segments.lead} Leads / {stats.segments.potential}{' '}
                  Potenciales
                </Typography>
              </Box>
            </Box>
            ...
            >
              <Box
                sx={{
                  ...
                  borderRadius: 4,
                  overflow: 'hidden',
                  bgcolor: theme.palette?.action?.hover || '#f1f1f2',
                  width: '100%',
                }}
              >
                <Tooltip title={`Leads: ${stats.segments.lead}`}>
                  <Box
                    sx={{
                      ...
                      width: `${stats.total > 0 ? (stats.segments.lead / stats.total) * 100 : 0}%`,
                    }}
                  />
                </Tooltip>
                <Tooltip
                  title={`Clientes Potenciales: ${stats.segments.potential}`}
                >
                  <Box
                    sx={{
                      bgcolor: 'primary.main',
                      width: `${stats.total > 0 ? (stats.segments.potential / stats.total) * 100 : 0}%`,
                    }}
                  />
                </Tooltip>
                <Tooltip title={`Clientes: ${stats.segments.customer}`}>
                  <Box
                    sx={{
                      ...
                      width: `${stats.total > 0 ? (stats.segments.customer / stats.total) * 100 : 0}%`,
                    }}
                  />
                </Tooltip>
                <Tooltip title={`Proveedores: ${stats.segments.supplier}`}>
                  <Box
                    sx={{
                      bgcolor: 'info.main',
                      width: `${stats.total > 0 ? (stats.segments.supplier / stats.total) * 100 : 0}%`,
                    }}
                  />
                </Tooltip>
              </Box>
              <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  >
                    ...
                    {Math.round(
                      stats.total > 0
                        ? (stats.segments.lead / stats.total) * 100
                        : 0
                    )}
                    %
                  </Typography>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  ...
                  >
                    ...
                    {Math.round(
                      stats.total > 0
                        ? (stats.segments.customer / stats.total) * 100
                        : 0
                    )}
                    %
                  </Typography>
          ...
          >
            ...
            >
              ...
              <Box sx={{ mt: 2 }}>
                ...
                <Typography variant="caption" color="text.secondary">
                  {stats.channels.hasEmail} Emails / {stats.channels.hasDoc}{' '}
                  Documentos
                </Typography>
              </Box>
            </Box>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    {Math.round(
                      stats.total > 0
                        ? (stats.channels.hasPhone / stats.total) * 100
                        : 0
                    )}
                    %
                  </Typography>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    {Math.round(
                      stats.total > 0
                        ? (stats.channels.hasEmail / stats.total) * 100
                        : 0
                    )}
                    %
                  </Typography>
              ...
              <Box>
                ...
                >
                  ...
                  >
                    {Math.round(
                      stats.total > 0
                        ? (stats.channels.hasDoc / stats.total) * 100
                        : 0
                    )}
                    %
                  </Typography>
