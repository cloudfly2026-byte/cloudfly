...
public class NotaDebitoMapper {
    ...
    public NotaDebito toEntity(NotaDebitoRequest request, Long tenantId) {
        NotaDebito nota = NotaDebito.builder()
                ...
                .estado(NotaDebito.EstadoNotaDebito.BORRADOR)
                .build();

        // Convertir items
        if (request.getItems() != null) {
            request.getItems().forEach(itemDTO -> {
                NotaDebitoItem item = toItemEntity(itemDTO);
                nota.addItem(item);
            });
        }
    ...
    public NotaDebitoItem toItemEntity(NotaDebitoItemDTO dto) {
        return NotaDebitoItem.builder()
    ...
    public NotaDebitoResponse toResponse(NotaDebito entity) {
        return NotaDebitoResponse.builder()
                .id(entity.getId())
                .tenantId(entity.getTenantId())
                .numeroNotaDebito(entity.getNumeroNotaDebito())
    ...
    public NotaDebitoItemDTO toItemDTO(NotaDebitoItem entity) {
        return NotaDebitoItemDTO.builder()
                .id(entity.getId())
