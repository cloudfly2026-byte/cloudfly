...
/**
 * Entidad NotaDebito - Nota Débito Electrónica DIAN UBL 2.1
 * Aumenta el valor de una factura electrónica
 */
@Entity
@Table(name = "notas_debito", indexes = {
        @Index(name = "idx_nd_tenant", columnList = "tenant_id"),
        @Index(name = "idx_nd_invoice_ref", columnList = "invoice_id_referencia"),
        @Index(name = "idx_nd_numero", columnList = "numero_nota_debito"),
        @Index(name = "idx_nd_estado", columnList = "estado"),
        @Index(name = "idx_nd_cufe", columnList = "cufe")
})
@Getter
@Setter
@NoArgsConstructor
...
public class NotaDebito {
    ...
    /**
     * Número interno de la nota de débito
     */
    @Column(name = "numero_nota_debito", unique = true, length = 50)
    private String numeroNotaDebito;

    /**
     * Prefijo DIAN para notas de débito (ej: ND)
     */
    ...
    /**
     * CUFE de esta nota de débito (generado al firmar)
     */
    ...
    /**
     * Ítems de la nota de débito (relación OneToMany)
     */
    ...
    /**
     * Indica si ya se generaron los movimientos contables
     */
    ...
    /**
     * ID del asiento contable que se generó
     */
     ...
     */
    public void addItem(NotaDebitoItem item) {
        items.add(item);
